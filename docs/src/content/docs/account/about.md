...
When integrating with the SDK, you often need details about the current account, the signed-in user, and the environment your code is running in. These are exposed as ready-to-read properties on the `kf` object — no method call required:
